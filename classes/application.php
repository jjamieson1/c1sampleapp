...
class Application {
    ...
    function getApprovalsByIdentityIdAndApplicationId($identityId, $applicationId) {
    ...
    function getApplicationLinksByApplicationId($applicationId) {
        require_once("../includes/config/database.php");
        $query = "select * from application_link where application_id= :applicationId";
        ...
        try {
            ...
            error_log($e->getMessage());
            $result['status'] = "failed";
            $result['error_message'] = "Failed to return links: " . $e->getMessage();
            return $result;
        }
        return $result;
    }
    ...
    function createApplication($app) {
        require_once("../includes/config/database.php");
        $query = "insert into application(name, description, form, api_key, app_key) values (:appname, :description, :form, :apikey, :appkey)";
        ...
        try {
            ...
            $stmt->bindParam("apikey", $app['api-key']);
            $stmt->bindParam("appkey", $app['app-key']);
            $stmt->execute();
